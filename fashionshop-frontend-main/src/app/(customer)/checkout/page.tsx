...
export default function CheckoutPage() {
  ...
  if (summaryQuery.isError) return <EmptyState title="Failed to load checkout" description={summaryQuery.error?.message || 'Something went wrong. Please try again.'} actionLabel="Go to cart" actionHref="/cart" />;
              ...
              <div className="mt-6 space-y-3">
                ...
                {summary.discountAmount > 0 && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-green-700">-${summary.discountAmount.toFixed(2)}</span>
                  </div>
                )}
